...
const Alert = ({children, type}) => {
 ...
 //   {type === 'success-sale' && }
  return (
    <>
    <AlertStyle >
            <div className={`container ${type === 'success-sale' && 'success' } ${type === 'insu-boxes' && 'error' } ${type === 'success-save' && 'success' } ${type === 'success-update' && 'success' } ${type === 'fail-sale1' && 'error' } ${type === 'fail-sale2' && 'error' } ${type === 'fail-sale3' && 'error' } ${type === 'missing-info' && 'error' }`}>
            ...
            <div className='alert-content'>
                ...
                {type === 'missing-info' && 'Los datos con * son necesarios para continuar' }
                {type === 'success-update' && 'Datos actualizados con exito' }
                {type === 'insu-boxes' && 'No hay cajas suficientes en el inventario revisa el apartado de materias primas' }
