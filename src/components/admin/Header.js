...
const Header = () => {
  const {location, pathname, showAddInv, setShowAddInv, showAddEI, setShowAddEI, typeAlert, setTypeAlert, showAlert, showConfBox, id_item, table, showAddI, setShowAddI, sesionData, turn, setTurn} = useContext(MainContext);
  const logOut = () =>{
      ...
      <div className="header-body">
        <div className="header-buttons">
          <div className="header-button">
            {pathname === 'inventario' || pathname === '' || pathname === '/' ? <button type="button" onClick={()=> setShowAddInv(true)}>Agregar producto</button>:""}
